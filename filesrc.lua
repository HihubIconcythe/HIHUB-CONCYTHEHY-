...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>HIHUB|CONCYTHE chào ae<Color=/>"):Display()
    wait(.5)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>flower hihub để xem video mới nhất nhé<Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "HIHUB|CONCYTHE", HidePremium = false, IntroText = "HIHUB|CONCYTHE⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("HIHUB|CONCYTHE SCRIPT")
W:AddLabel("DiscordHIHUB|CONCYTHE")
local Section = W:AddSection({
    Name = "Status"
})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "HIHUB|CONCYTHE(Noitification)",
